 ...
 * @LastEditTime: 2022-08-30 23:07:56
...
export function get(url, mock, FSW = true) {
  ...
  return function(params, option = {}) {
    ...
    // 配置提示
    option._notify = Object.prototype.hasOwnProperty.call(option, 'notify')
      ? option.notify
      : Config.globalNotify;
    // 配置错误提示
    option._errorNotify = Object.prototype.hasOwnProperty.call(option, 'errorNotify')
      ? option.errorNotify
      : Config.globalErrorNotify;
    return http({
      url,
      params,
      ...option,
