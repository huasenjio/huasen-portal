 ...
 * @LastEditTime: 2022-09-21 00:55:24
 * @Description: 
-->
<template>
    ...
    <div class="custom-wallpaper-drawer">
      <el-collapse class="collapse" v-model="activeName" accordion>
        ...
        <el-collapse-item name="1">
          ...
          <div class="collapse-content">
            <section class="other">
              <div>纯色背景</div>
              <ul>
                <li v-for="(item, index) in pures" :key="index" :style="{ backgroundColor: item.background }" @click="changeBg(item)"></li>
                <li>
        ...
        <el-collapse-item name="2">
          ...
          <div class="collapse-content">
            <ul class="image">
              <li v-for="(item, index) in wallpaperImages" :key="index" :style="{ backgroundImage: `url(${item.background})` }" @click="changeBg(item)">
                <div class="setting">
                  立即设置
                </div>
              </li>
  ...
  data() {
    return {
      ...
      wallpaperImages: [
        ...
        {
          headerFontColor: '#FFFFFF',
          background: 'http://a.huasen.cc/server/huasen-public-static/admin/1651394773795.jpeg',
        },
        {
          headerFontColor: '#FFFFFF',
          background: 'http://a.huasen.cc/server/huasen-public-static/admin/1651395053333.jpeg',
        },
      ],
    };
  },
  ...
  methods: {
    ...
    beforeUpload(file) {
      ...
      if (file.size <= 3145728) {
        ...
        this.$tips('error', '图片大小已超过 3mb', null, 2000);
      }
      return false; // 终止上传
    },
